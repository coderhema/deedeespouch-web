    ...
    <section id="order-now" className="px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
      <div className="mx-auto max-w-6xl rounded-[2rem] border border-violet-100 bg-violet-900 px-6 py-8 text-white shadow-[0_30px_90px_rgba(46,22,95,0.32)] sm:px-8 sm:py-10 lg:px-10">
        <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: '-10% 0px' }} variants={reveal} transition={{ ...transition, delay: 0.08 }} className="rounded-[1.5rem] border border-white/15 bg-white/10 p-6 backdrop-blur">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              transition={spring}
              className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-full bg-white px-6 py-3.5 text-sm font-semibold text-violet-900"
            >
